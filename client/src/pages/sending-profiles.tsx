  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-foreground" data-testid="text-page-title">Профили отправки</h1>
          <p className="text-muted-foreground mt-1">Настройка SMTP серверов для отправки писем</p>
        </div>
